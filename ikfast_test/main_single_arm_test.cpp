...
int main()
{
    ...
    // 测试已知的末端执行器旋转矩阵和位移
    // 取前三行，每行四个数，共12个，按Row-major排布：
    // std::vector<float> ee_pose = {// Row 1
    //                               -1.0f, -1.07553e-06f, 9.00562e-05f, 0.452049f,
    //                               // Row 2
    //                               -6.44401e-05f, 0.707104f, -0.707109f, -0.626356f,
    //                               // Row 3
    //                               -6.29186e-05f, -0.707109f, -0.707104f, -0.0212478f};
